...
import Subject from "./TreeView.svelte";
...
describe("TreeView", () => {
    test("renders a tree", () => {
        render(Subject, { props: { label: "Files", children: treeItemsSnippet() } });
        expect(screen.getByRole("tree")).toBeTruthy();
    });

    test("has aria-label", () => {
        render(Subject, { props: { label: "File browser", children: treeItemsSnippet() } });
    ...
    test("passes through attributes", () => {
        render(Subject, { props: { label: "F", "data-testid": "tv", children: treeItemsSnippet() } });
