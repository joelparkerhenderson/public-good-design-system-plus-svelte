...
import Subject from "./TreeMenu.svelte";
...
describe("TreeMenu", () => {
    ...
    test("has aria-label", () => {
        render(Subject, { props: { label: "Navigation", children: treeItemsSnippet() } });
    ...
    test("passes through attributes", () => {
        render(Subject, { props: { label: "N", "data-testid": "tm", children: treeItemsSnippet() } });
