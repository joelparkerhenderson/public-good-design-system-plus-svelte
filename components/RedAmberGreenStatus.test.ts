...
import Subject from "./RedAmberGreenStatus.svelte";

describe("RedAmberGreenStatus", () => {
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "S", "data-testid": "rag" } });

        expect(screen.getByTestId("rag")).toBeTruthy();
    });
});
