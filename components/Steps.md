...
A steps component displays a sequence of stages or actions in a process, workflow, wizard, or multi-step form. Steps help users understand where they are in a multi-stage process, what they have completed, and what remains ahead. They are commonly used in checkout flows, registration processes, onboarding wizards, and multi-part forms.
