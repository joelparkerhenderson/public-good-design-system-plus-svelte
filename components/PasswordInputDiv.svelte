<script lang="ts">
    ...
    //   <PasswordInputDiv label="Password" bind:value showToggle={false} />
    //
    //   <!-- Custom toggle label for internationalization -->
    //   <PasswordInputDiv label="Mot de passe" bind:value toggleLabel="Afficher le mot de passe" />
    //
    // Keyboard:
...
<!-- PasswordInputDiv.svelte -->
<div
    class={`password-input-div ${className}`}
    {...restProps}
>
    <input
