<script lang="ts">
    ...
    //
    // Usage:
    //   <AngleSlider label="Rotation" bind:value={angle} />
    //   <AngleSlider label="Direction" value={90} min={0} max={360} step={15} />
    //
    // Props:
...
<!-- AngleSlider: a range input for selecting an angle in degrees -->
<input
    type="range"
    bind:value={value}
    {min}
