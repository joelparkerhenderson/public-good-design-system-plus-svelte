...
import Subject from "./RedOrangeYellowGreenBlueIndicatorStatus.svelte";

describe("RedOrangeYellowGreenBlueIndicatorStatus", () => {
    ...
    test("passes through additional HTML attributes", () => {
        render(Subject, { props: { label: "S", "data-testid": "roygb" } });

        expect(screen.getByTestId("roygb")).toBeTruthy();
    });
});
