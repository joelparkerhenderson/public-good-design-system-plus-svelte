...
describe("Checklist", () => {
    test("renders as a list", () => {
        render(Subject, { props: { label: "Tasks", children: textSnippet("Items") } });
    ...
    test("applies aria-label", () => {
        render(Subject, { props: { label: "Onboarding", children: textSnippet("Items") } });
        expect(screen.getByRole("list").getAttribute("aria-label")).toBe("Onboarding");
    });
