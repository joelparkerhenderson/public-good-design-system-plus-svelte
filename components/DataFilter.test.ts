...
import Subject from "./DataFilter.svelte";
...
describe("DataFilter", () => {
    test("renders as a search form", () => {
        render(Subject, { props: { label: "Filter", children: textSnippet("Controls") } });
        expect(screen.getByRole("search", { name: "Filter" })).toBeTruthy();
    });

    test("has aria-label", () => {
        render(Subject, { props: { label: "Filter results", children: textSnippet("Controls") } });
        expect(screen.getByRole("search").getAttribute("aria-label")).toBe("Filter results");
    });

    test("renders children", () => {
        render(Subject, { props: { label: "Filter", children: textSnippet("My controls") } });
    ...
    test("passes through attributes", () => {
        render(Subject, { props: { label: "Filter", "data-testid": "df", children: textSnippet("C") } });
