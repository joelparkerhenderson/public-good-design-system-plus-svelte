...
import Subject from "./ThemeChooser.svelte";
...
describe("ThemeChooser", () => {
    ...
    test("has aria-label", () => {
        render(Subject, { props: { label: "Choose theme", children: optionsSnippet() } });
    ...
    test("passes through attributes", () => {
        render(Subject, { props: { label: "T", "data-testid": "tc", children: optionsSnippet() } });
