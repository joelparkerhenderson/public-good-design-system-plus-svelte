<script lang="ts">
    ...
    //
    // Claude rules:
    //   - Headless: no CSS, no styles — consumer provides all styling (e.g., border-left, indentation)
    //   - No internal state; purely a presentational container
    //   - Inspired by GOV.UK and NHS England "inset text" pattern
    //
    // References:
