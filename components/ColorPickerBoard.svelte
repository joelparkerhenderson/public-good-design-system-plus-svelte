<script lang="ts">
    ...
    //
    // Syntax:
    //   <ColorPickerBoard label="Color saturation and brightness" bind:x bind:y />
    //
    // Examples:
    //   <!-- Disabled board with initial position -->
    //   <ColorPickerBoard label="Select color" bind:x bind:y disabled />
    //
    // Keyboard:
