<script lang="ts">
    ...
    //   <FiveStarRatingInput label="Rate this product" bind:value={rating} />
    //
    //   <!-- Disabled star rating -->
    //   <FiveStarRatingInput label="Your rating" bind:value disabled />
    //
    // Keyboard:
...
<!-- FiveStarRatingInput component: a radiogroup fieldset for selecting one of five star ratings -->
<fieldset
    role="radiogroup"
    aria-label={label}
    {disabled}
